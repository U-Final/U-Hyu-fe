export const ADMIN_CATEGORIES = [
  { id: 9, name: '음식점', color: 'var(--category-restaurant)' },
  { id: 10, name: '베이커리/디저트', color: 'var(--category-bakery)' },
  { id: 7, name: '생활/편의', color: 'var(--category-convenience)' },
  { id: 8, name: '쇼핑', color: 'var(--category-shopping)' },
  { id: 5, name: '뷰티(피부과, 클리닉)', color: 'var(--category-beauty)' },
  { id: 6, name: '건강(제약, 영양제 등)', color: 'var(--category-health)' },
  ...
  { id: 4, name: '액티비티', color: 'var(--category-activity)' },
  { id: 11, name: '테마파크', color: 'var(--category-themepark)' },
  { id: 3, name: '워터파크/아쿠아리움', color: 'var(--category-waterpark)' },
...
export const CATEGORY_BRANDS = {
  9: ['VIPS', '더플레이스', '제일제면소', '유가네닭갈비', '라그릴리아', '반올림피자', '서울드레곤시티', '굽네치킨', '컬리너리스퀘어', '세빛섬', '베베쿡', '도미노피자', '미스터피자', '파파존스', '피자헛', '온더보더', '푸드엠파이어', '싱카이', '키사라'],
  10: ['파리바게트', '뚜레쥬르', '베스킨라빈스', '파리크라상', '브레댄코'],
  7: ['GS25', '펫생각', '셸로', '다락', 'KCC글라스', '뮤직벨링', '어바웃펫', 'GS POSTBOX택배', '가연결혼정보', '포토블루', '통인익스프레스', '쿠프마케팅', '청소연구소', '자란다', '오토오아시스', 'KB손해보험'],
  ...
  5: ['오가나셀 피부과 의원 청담점', '데이원클리닉', '포쉬네일', '유엔아이피부과의원'],
  6: ['동아제약 디몰', 'LG생활건강샵 U+패밀리샵', '필리'],
  ...
  4: ['스카이라인 루지', '클룩', '부산 엑스 더 스카이', '대관령 하늘목장', 'LG트윈스 경기 티켓 할인', '이월드', '제주민속촌', 'SEOUL SKY', '한강유람선 이크루즈'],
  11: ['뽀로로파크', '아르떼 키즈파크 제주', '원더빌리지', '원더파크', '서울랜드', '뽀로로아쿠아빌리지', '롯데월드 아이스링크', '롯데월드 어드벤쳐 부산'],
  3: ['아쿠아필드', '스파랜드', '클럽디 오아시스', '코엑스아쿠아리움', '아쿠아플라넷', '부산아쿠아리움', '캐리비안베이', '대구아쿠아리움', '롯데월드 아쿠아리움'],
