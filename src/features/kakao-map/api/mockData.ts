...
export const MOCK_STORE_DETAILS: Record<number, StoreDetail> = {
  1: {
    ...
    benefits: {
      grade: 'GOLD',
      benefitText: '카드 결제 시 5% 할인, 스타벅스 리워드 적립',
    },
    usageLimit: '1일 1회 사용 가능',
    usageMethod: '모바일 앱에서 쿠폰 사용 후 결제',
  },
  2: {
    storeName: '투썸플레이스 강남역점',
    isFavorite: true,
    ...
    benefits: {
      grade: 'SILVER',
      benefitText: '모바일 주문 시 10% 할인, 투썸 포인트 적립',
    },
  ...
  3: {
    ...
    benefits: {
      grade: 'BRONZE',
      benefitText: 'GS&POINT 적립, 특정 상품 할인',
    },
    usageLimit: '제한 없음',
  ...
  4: {
    ...
    benefits: {
      grade: 'GOLD',
      benefitText: '올리브영 포인트 적립, 멤버십 혜택',
    },
