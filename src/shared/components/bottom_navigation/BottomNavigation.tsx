  ...
  return (
    <div className="fixed bottom-0 w-full">
      <nav className="h-12 text-[0.625rem] shadow-nav flex relative justify-around bg-white gap-5 px-[1.5rem] py-[0.5rem]">
          <NavLink to="/" className="flex gap-4" onClick={() => handleTabClick("홈")}>
            <NavItem
              label="홈"
              icon={<MdHomeFilled />}
          ...
          <NavLink to="/map" className="flex gap-4" onClick={() => handleTabClick("지도")}>
            <NavItem
              label="지도"
              icon={<FaMap />}
        ...
        />
          <NavLink to="/benefit" className="flex gap-4" onClick={() => handleTabClick("혜택")}>
            <NavItem
              label="혜택"
              icon={<HiGift />}
          ...
          <NavLink to="/mypage" className="flex gap-4" onClick={() => handleTabClick("마이페이지")}>
            <NavItem
              label="마이페이지"
              icon={<FaUser />}
